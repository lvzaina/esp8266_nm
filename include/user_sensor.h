...
#define SENSOR_WIFI_LED_IO_MUX     PERIPHS_IO_MUX_MTMS_U
#define SENSOR_WIFI_LED_IO_NUM     14
#define SENSOR_WIFI_LED_IO_FUNC    FUNC_GPIO14

#define SENSOR_LINK_LED_IO_MUX     PERIPHS_IO_MUX_MTCK_U
#define SENSOR_LINK_LED_IO_NUM     13
#define SENSOR_LINK_LED_IO_FUNC    FUNC_GPIO13
